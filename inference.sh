#!/bin/bash
#SBATCH --job-name=arrays_inference    # Job name
#SBATCH --output=logs/inference/pythia_%j.out        # Standard output and error log (%j expands to jobID)
#SBATCH --error=logs/inference/pythia_%j.err         # Error log
